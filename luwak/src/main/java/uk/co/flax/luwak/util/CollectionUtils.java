...
public final class CollectionUtils {
    ...
    @SafeVarargs
    public static <T> List<QueryTreeBuilder<? extends Query>> makeUnmodifiableList(T... items) {
        ArrayList<T> list = new ArrayList<>(items.length);
        Collections.addAll(list, items);
        return (List<QueryTreeBuilder<? extends Query>>) Collections.unmodifiableList(list);
    }
